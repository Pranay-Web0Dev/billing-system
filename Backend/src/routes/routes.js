...
import { addProduct, countProducts, deleteProduct, getAllProducts, searchByBarcode, updateProductById } from '../controllers/productController.js'
...
router.get('/product/get/:barcode', searchByBarcode)
